 ...
 <br/>
          ...
          <div class="tile">
            ...
            <p>WOODEN Aura </p>
                ...
                <?php         $id=$_GET['Gotid'];							
$query=mysqli_query($Wooden_AuraConnection,"select * from production  where production_id = '$id'")or die(mysqli_error());
...
?>
                ...
                <br/>
                Invoice#: <?php echo $row['production_id'];?>  
...
$id=$_GET['Gotid'];							
$query=mysqli_query($Wooden_AuraConnection,"SELECT * FROM productionetails join material on productionetails.material_id = material.material_id   where requested_id = '$id' ")or die(mysqli_error());
