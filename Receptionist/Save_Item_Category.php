...
if(isset($_POST['submit'])){ //from btn name start 
  ...
  if ($readAction > 0)
  {
    ...
    swal("Saved!", " " + cat_name + "  Category   Successfully Saved  " , "success");
      ...
      echo "<script>document.location='View_Item_Category.php'</script>";
	  }
            ...
            <div class="tile-body">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text"   name="cat_name" required pattern="[A-Za-z. ]+">
                </div>
                
      
                <div class="form-group col-md-6">
                  <label class="control-label">Category Note  </label>
                  <input class="form-control" type="text"   name="cat_note" required pattern="[A-Za-z. ]+">
                </div>
