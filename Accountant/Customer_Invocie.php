...
$id=$_GET['Gotid'];							
$query=mysqli_query($Wooden_AuraConnection,"select * from salesbackup left join item on salesbackup.prod_id = item.prod_id  where requested_id = '$id' ")or die(mysqli_error());
