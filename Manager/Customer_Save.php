            ...
            <div class="tile-body">
              <form  method="post" method="post" enctype='multipart/form-data'>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="Staff Name" name="customer_name" required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="number" placeholder="Contact Number" name="customer_contact" required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="Email" name="customer_email" onchange="ValidateEmail()" id="txtEmail" required>
                </div>
