...
$query=mysqli_query($Wooden_AuraConnection,"select * from payment_hold  join payment_backup on payment_hold.requested_id = payment_backup.requested_id join material_supplier on material_supplier.supplier_id = payment_hold.supplier")or die(mysqli_error());
