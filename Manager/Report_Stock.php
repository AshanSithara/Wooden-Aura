...
$query=mysqli_query($Wooden_AuraConnection,"select * from item left join item_category on item.cat_id = item_category.cat_id  where  serial = '$search_stockID' ")or die(mysqli_error());
