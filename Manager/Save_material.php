...
if(isset($_POST['submit'])){ 
  ...
  if ($readAction > 0)
  {
    ...
    mysqli_query($Wooden_AuraConnection,"INSERT INTO material(material_serial,material_name,material_price,minimum_qty,material_qty) VALUES('$material_serial','$material_name','$material_price','$material_qty','$minimum_qty')")or die(mysqli_error($Wooden_AuraConnection));
    echo "<script> material_name = " . json_encode($material_name) . "</script>";
    echo '<script type="text/javascript">
    swal("Saved!", " " + material_name + "  Food   Successfully Saved  " , "success");
      </script>';
	  }
            ...
            <div class="tile-body">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text"  name="material_price"   >
                </div>

                <div class="form-group col-md-6">
                  <label class="control-label">Material Qty    </label>
                  <input class="form-control" type="text"   name="material_qty"  >
                </div>


                <div class="form-group col-md-6">
                  <label class="control-label">Minimum Qty    </label>
                  <input class="form-control" type="text"   name="minimum_qty"  >
                </div>
