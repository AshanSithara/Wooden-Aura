...
?>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small  coloured-icon" style="color: black; background-color: white;">
          <a href="stock%20_Alert_report.php" style="background-color: #98AFC7;">
           <i class="icon fa fa-stack-exchange fa-3x" style="color: white;"></i> 
          </a>
            <div class="info">
...
?>
        ...
        <div class="col-md-6 col-lg-3">
          ...
          <i class="icon fa fa-industry" style="color: white;">
          </i> 
        </a>
...
?>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small  coloured-icon" style="color: black; background-color: white;">
          <a href="Report_Sales_return.php" style="background-color: #006400;"> 
      ...
      <br /><br />
        ...
        <script>
          ...
          stacked:true
            ...
            <div class="info"> 
             <?php 
          $result=mysqli_query($Wooden_AuraConnection,"SELECT date_added,sum(made_qty) as total FROM production group by date_added")or die(mysqli_error());
          $chart_data = '';
          while($row = mysqli_fetch_array($result))
      {
          $chart_data .= "{ date_added:'".$row["date_added"]."', total:".$row["total"]."}, ";
