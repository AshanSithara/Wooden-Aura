...
?>         
  <form class="row"  method="post" enctype='multipart/form-data'>
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text"   name="customer_name" value="<?php echo($name)?>" required>
                </div>
              ...
              <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text"   name="customer_contact" value="<?php echo($contact)?>" required>
                </div>
                
      
                <div class="form-group col-md-6">
                  <label class="control-label"> Contact  </label>
                  <input class="form-control" type="text"   name="customer_email" value="<?php echo($job)?>" required>  
