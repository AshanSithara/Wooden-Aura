...
<main class="app-content">
      ...
      <div class="app-title">
        ...
        <li class="breadcrumb-item"> </li>
          <li class="breadcrumb-item"><a > Production History Ivoices       </a></li>
        </ul>
      </div>
...
?>
                  <tr>
                    ...
                    <a href="#.php?Gotid=<?php echo $row['sales_id']; ?>"  class="btn btn-info btn-sm" name="btn_edit"><i class="fa fa-lg fa-print"></i></a>
