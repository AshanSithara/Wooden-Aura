...
?>         
  <form class="row"  method="post" enctype='multipart/form-data'>
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text"   name="supplier_name" value="<?php echo($supplier_name)?>" pattern="[A-Za-z. ]+" required>
                </div>
              ...
              <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text"   name="supplier_contact" value="<?php echo($supplier_contact)?>"  onkeypress="return isNumberKey(evt)" onchange="phonenumber()" id="txtTell" required>
                </div>
                
      
                <div class="form-group col-md-6">
                  <label class="control-label">Supplier NIC </label>
                  <input class="form-control" type="text"   name="supplier_nic" value="<?php echo($supplier_nic)?>" name="supplier_nic"  onchange="nicnumber()"   id="txtNIC"  >
                </div>
