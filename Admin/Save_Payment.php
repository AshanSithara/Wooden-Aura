...
if(isset($_POST['submit'])){ 
  ...
  if ($readAction > 0)
  {
    ...
    mysqli_query($Wooden_AuraConnection,"INSERT INTO supplier_payment(serial,supplier_name,date,ammount,requested_id,P_id) VALUES('$serial','$supplier_name','$date','$ammount','$requested_id','$P_id')")or die(mysqli_error($Wooden_AuraConnection));
    }
