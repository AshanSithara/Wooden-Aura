        ...
        if(isset($_POST['submit'])){ // connect to button
          ...
          // check for existing data
            ...
            {   echo '<script type="text/javascript">
              ...
              mysqli_query($Wooden_AuraConnection,"INSERT INTO employee(name,Job,contact,Email,Password,photo)
              VALUES('$Name','$Job','$contact','$Email','$Password','$pic')")or die(mysqli_error($Wooden_AuraConnection));
