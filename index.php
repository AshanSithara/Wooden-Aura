 ...
 // no Account fond with input 
    ...
    {	
...

                       {
                        ...
                        if ($UserRole == 'accountant') //user Role check
                        {
                         session_start();
                         $_SESSION['userid']=$userid;	 
                         $_SESSION['StaffName']=$StaffName;	
                         ...
                         echo '<script type="text/javascript">
                         swal("Success", "Accountant Successfully logged" , "success");
                           </script>';
 
                           echo '<script>
                                    setTimeout(function(){
                                       window.location.href = "Accountant/dashborad.php";
                                    }, 2000);
                                 </script>';
 
                         }

                         if ($UserRole == 'receptionist') //user Role check
                        {
                         session_start();
                         $_SESSION['userid']=$userid;	 
                         $_SESSION['StaffName']=$StaffName;	
                         ...
                         echo '<script type="text/javascript">
                         swal("Success", "Receptionist Successfully logged" , "success");
                           </script>';
 
                           echo '<script>
                                    setTimeout(function(){
                                       window.location.href = "Receptionist/dashborad.php";
                                    }, 2000);
                                 </script>';
